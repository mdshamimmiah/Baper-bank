...
const Navber = () => {
  ...
  const handleLogOut = () =>{
    ...
    <div className='flex gap-2'>
        ...
        <li className="shadow-[#f72e05]	shadow-2xl bg-black text-white"><NavLink to='/balance'>Balance page</NavLink></li>
        <li className="shadow-[#f72e05]	shadow-2xl bg-black text-white"><NavLink to='/trainer'>About Page</NavLink></li>
    ...
    return (
        ...
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost text-xl text-white">Baper Bank</a>
        </div>
